...
namespace Orojas.Api.Controllers
{
    ...
    public class TipoDocumentoController : ControllerBase
    {
        ...
        [HttpGet]
        [ActionName("ObtenerTipoDocumentos")]
        ...
        public async Task<IActionResult> ObtenerTipoDocumento(string Id)
        {
        ...
        public async Task<IActionResult> CrearTipoDocumento(UsuarioViewModel usuario)
        {
        ...
        [Authorize(AuthenticationSchemes = "Bearer")]
        [HttpDelete("{id}")]
        [ActionName("EliminarTipoDocumento")]
        public async Task<IActionResult> EliminarTipoDocumento(string Id)
        {
        ...
        [Authorize(AuthenticationSchemes = "Bearer")]
        [HttpPut]
        [ActionName("ActualizarTipoDocumento")]
        public async Task<IActionResult> ActualizarTipoDocumento(UsuarioViewModel usuario)
        {
